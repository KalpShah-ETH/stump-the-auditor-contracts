...
///       mutation path.
///     - Early-unstake penalties are credited immediately to the existing eligible boosted supply, excluding the
///       penalized user's remaining stakes. If no eligible cohort exists, the penalty waits in `queuedPenalty`.
